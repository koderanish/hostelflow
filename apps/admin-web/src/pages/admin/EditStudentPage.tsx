          ...
          <div className="border-t border-slate-200 dark:border-slate-800 pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              <div className="space-y-1.5">
                ...
                <input type="text" value={year} onChange={e => setYear(e.target.value)} className={inputClass} />
              </div>
              <div className="space-y-1.5">
                <label className={labelClass}>Semester *</label>
                <input type="text" value={semester} onChange={e => setSemester(e.target.value)} className={inputClass} />
              </div>
              <div className="space-y-1.5">
          ...
          <div className="border-t border-slate-200 dark:border-slate-800 pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              <div className="space-y-1.5">
                ...
                <input type="text" value={parentContact} onChange={e => setParentContact(e.target.value)} className={inputClass} />
              </div>
              <div className="space-y-1.5">
              ...
              <div className="space-y-1.5">
                ...
                <input type="text" value={emergencyContactPhone} onChange={e => setEmergencyContactPhone(e.target.value)} className={inputClass} />
              </div>
              <div className="space-y-1.5">
                <label className={labelClass}>Emergency Contact Relation</label>
                <input type="text" value={emergencyContactRelation} onChange={e => setEmergencyContactRelation(e.target.value)} className={inputClass} />
              </div>
              <div className="space-y-1.5">
